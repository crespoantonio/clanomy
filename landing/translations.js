...
const TRANSLATIONS = {
  en: {
    ...
    // Solo Pro Card
    "solo.name": "Solo Pro",
    "solo.desc": "For individuals wanting complete financial clarity, high AI logging, and Notion sync.",
    "solo.f1": "✓ <b>1 User</b> workspace",
    "solo.f2": "✓ Up to <b>60 AI messages/day</b> (voice & text)",
    "solo.f3": "✓ <b>Real-time Notion Sync</b>",
    "solo.f4": "✓ Smart AI cash flow queries",
    "solo.f5": "✓ Bills & due date tracker",
    "solo.f6": "✓ CSV & JSON data export",
    "solo.f7": "✓ Self-service customer billing portal",
    ...
    "duo.f2": "✓ <b>2 Partner / Household Members</b>",
    "duo.f3": "✓ Up to <b>120 shared AI messages/day</b> (pool)",
    "duo.f4": "✓ Shared & private expense tags",
    "duo.f5": "✓ Shared Notion database mirror",
    "duo.f6": "✓ Couple balance & savings analytics",
    "duo.f7": "✓ Self-service billing portal",
    ...
    "family.f2": "✓ <b>Up to 5 Members</b>",
    "family.f3": "✓ Up to <b>300 shared AI messages/day</b> (pool)",
    "family.f4": "✓ Multi-currency segregation",
    "family.f5": "✓ Per-member spending attribution",
    "family.f6": "✓ Shared Notion family database",
    "family.f7": "✓ Priority email support",
  ...
  es: {
    ...
    "solo.f4": "✓ Consultas inteligentes de flujo de caja con IA",
    "solo.f5": "✓ Rastreador de facturas y fechas de vencimiento",
    "solo.f6": "✓ Exportación de datos en CSV y JSON",
    "solo.f7": "✓ Portal de facturación de autoservicio",
    ...
    "duo.f2": "✓ <b>2 Integrantes / Parejas</b>",
    "duo.f3": "✓ Hasta <b>120 mensajes IA/día compartidos</b> (grupo)",
    "duo.f4": "✓ Etiquetas de gastos compartidos y privados",
    "duo.f5": "✓ Reflejo de base de datos en Notion compartida",
    "duo.f6": "✓ Analíticas de ahorro y balance de pareja",
    "duo.f7": "✓ Portal de facturación de autoservicio",
    ...
    "family.f2": "✓ <b>Hasta 5 Integrantes</b>",
    "family.f3": "✓ Hasta <b>300 mensajes IA/día compartidos</b> (grupo)",
    "family.f4": "✓ Segregación multimoneda",
    "family.f5": "✓ Atribución de gastos por integrante",
    "family.f6": "✓ Base de datos familiar compartida en Notion",
    "family.f7": "✓ Soporte prioritario por email",
