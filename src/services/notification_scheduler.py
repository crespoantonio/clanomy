...
def format_day_50_message(family: Family, tx_count: int, days_remaining: int) -> str:
    ...
    return (
        ...
        "Type /upgrade to choose your plan and continue enjoying unlimited access!"
    )
...
def format_day_60_message(family: Family) -> str:
    ...
    return (
        ...
        "Type /upgrade anytime to activate <b>Solo Pro</b> (150 Stars/mo) or <b>Family Pro</b> (300 Stars/mo)!"
    )
